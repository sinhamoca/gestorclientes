...
import * as paymentController from './controllers/paymentController.js'; // ← NOVO!
...
// IMPORTANTE: Estas rotas precisam ser públicas para funcionar!
app.get('/pay/:token', paymentController.renderPaymentPage);
app.get('/payment/success', paymentController.paymentSuccess);
app.get('/payment/failure', paymentController.paymentFailure);
app.get('/payment/pending', paymentController.paymentPending);
...
async function start() {
  try {
    ...
    app.listen(PORT, '0.0.0.0', () => {
      ...
      console.log(`💳 Sistema de pagamentos: Ativo`); // ← NOVA LINHA!
    });
  } catch (error) {
