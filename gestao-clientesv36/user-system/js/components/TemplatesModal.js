/* ========================================
   TEMPLATES MODAL COMPONENT - COM {{fatura}}
   ======================================== */
...
function TemplatesModal({ templates, onClose, onRefresh }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormData({ name: '', type: 'vencimento_dia', message: defaultMessage });      onRefresh();
    } catch (error) {
      alert(error.message);
    } finally {
      setLoading(false);
          ...
          <form onSubmit={handleSubmit} className="mb-6 p-4 bg-gray-50 rounded-lg">
            ...
            <div className="mb-4">
              ...
              <p className="text-xs text-gray-500 mt-2">
                💡 Use <strong>{'{{fatura}}'}</strong> para incluir o link de pagamento automaticamente!
              </p>
            </div>
