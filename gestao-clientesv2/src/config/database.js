  ...
  try {
    ...
    await query(`
      CREATE TABLE IF NOT EXISTS message_templates (
        ...
        user_id INTEGER REFERENCES users(id) ON DELETE CASCADE,
        name VARCHAR(100) NOT NULL,
        type VARCHAR(50) NOT NULL, -- pre_vencimento, vencimento_dia, pos_vencimento, personalizado
    ...
    // Tabela de Lembretes (Regras de Envio)
    await query(`
      CREATE TABLE IF NOT EXISTS reminders (
        ...
        days_offset INTEGER NOT NULL, -- Negativo = antes, 0 = no dia, Positivo = depois
        send_time TIME DEFAULT '09:00:00', -- Horário de envio
        is_active BOOLEAN DEFAULT true,
        created_at TIMESTAMP DEFAULT NOW(),
        updated_at TIMESTAMP DEFAULT NOW()
      );
    ...
    // Tabela de Instâncias WhatsApp (NOVA)
    await query(`
    ...
    console.log('✅ Database initialized with Templates and Reminders');
  } catch (error) {
