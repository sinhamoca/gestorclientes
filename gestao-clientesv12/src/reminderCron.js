  ...
  try {
    ...
    for (const reminder of reminders) {
      ...
      for (const client of clients) {
        // ⚠️ PROTEÇÃO DE DUPLICAÇÃO REMOVIDA!
        // Agora envia SEMPRE, mesmo se já enviou hoje
        
        // Verifica se já está na fila (mantém para evitar duplicatas NA FILA)
        ...
        await query(
          `INSERT INTO message_queue 
           (user_id, instance_name, client_id, reminder_id, template_id, 
            whatsapp_number, message, scheduled_for, status)
