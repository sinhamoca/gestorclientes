...
function ServersModal({ servers, onClose, onRefresh }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEditingId(null);
      onRefresh();
      toast.success(wasEditing ? 'Servidor atualizado!' : 'Servidor criado!');
    } catch (error) {
            ...
            <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start gap-3">
                <CustomCheckbox
                  ...
                  color="blue"
                />
                <div className="cursor-pointer" onClick={() => setFormData({...formData, multiply_by_screens: !formData.multiply_by_screens})}>
