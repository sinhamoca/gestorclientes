  ...
  try {
    ...
    await query(`
      CREATE TABLE IF NOT EXISTS financial_transactions (
        ...
        type VARCHAR(20) NOT NULL, -- 'renewal', 'new_client', 'cancellation'
        
        amount_received DECIMAL(10,2) NOT NULL, -- Valor recebido do cliente
        server_cost DECIMAL(10,2) NOT NULL, -- Custo do servidor
        net_profit DECIMAL(10,2) NOT NULL, -- Lucro líquido (amount - cost)
        
        due_date DATE NOT NULL, -- Data do vencimento relacionado
        paid_date DATE, -- Data que foi pago (NULL = pendente)
        status VARCHAR(20) DEFAULT 'pending', -- 'pending', 'paid', 'cancelled'
        
        payment_method VARCHAR(50), -- 'pix', 'cash', 'credit_card', etc
        notes TEXT,
    ...
    await query(`
      CREATE INDEX IF NOT EXISTS idx_transactions_paid_date 
      ON financial_transactions(paid_date);
    `);
