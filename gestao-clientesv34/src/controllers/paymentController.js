    ...
    async function generatePix() {
      try {
        ...
        container.innerHTML = \`
          ...
          <img src="data:image/png;base64,\${data.qr_code_base64}" alt="QR Code PIX" style="max-width: 280px; margin: 20px auto; display: block;" />
        ...
        if (data.transactions && data.transactions.length > 0) {
          ...
          data.transactions.forEach(tx => {
            ...
            if (tx.unitv_codes_formatted && tx.unitv_codes_formatted.length > 0) {
              html += '<div style="font-size: 12px; color: #666; margin-top: 8px;"><strong>🎫 Código';
              ...
              for (let i = 0; i < tx.unitv_codes_formatted.length; i++) {
                html += '<div style="display: flex; align-items: center; gap: 10px; margin-bottom: 5px;"><span style="font-family: monospace; font-weight: 600;">';
