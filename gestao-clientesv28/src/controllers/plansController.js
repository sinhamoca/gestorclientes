// gestao-clientesv27/src/controllers/plansController.js
// ATUALIZADO COM SUPORTE CLUB
  ...
  try {
    ...
    if (typeCount > 1) {
      return res.status(400).json({ 
        error: 'Plano não pode ter múltiplos tipos simultaneamente. Escolha apenas um tipo: Sigma, Live21, Koffice, Uniplay, UniTV ou Club.'
      });
    }
